...
object Input {
  ...
  //Dummy just to make it exists
  @data class File(file: scala.Predef.String, charset: Charset = Charset.forName("UTF-8")) extends Input {
    lazy val chars = file.toArray
    override def toString = "Input.File(\"" + file + "\")"
    def getName = "<input>"
  }
/*
  object File {
